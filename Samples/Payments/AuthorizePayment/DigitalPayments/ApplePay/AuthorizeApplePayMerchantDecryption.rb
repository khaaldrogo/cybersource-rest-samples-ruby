...
public
class AuthorizeApplePayMerchantDecryption
  def main
    ...
    processingInformation.payment_solution = "001"
    ...
    tokenizedCardInformation.cryptogram = "AceY+igABPs3jdwNaDg3MAACAAA="
  ...
  AuthorizeApplePayMerchantDecryption.new.main
end
