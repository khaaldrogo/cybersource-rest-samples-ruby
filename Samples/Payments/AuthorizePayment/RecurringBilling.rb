...
class RecurringBilling
  def main
    ...
    amountInformation.total_amount = "5432"
    ...
    customerInformation = CyberSource::V2paymentsPaymentInformationCustomer.new
    customerInformation.customer_id = "5303162577043192705841"
