...
class AmericanExpress
  def main
    ...
    transactionAdviceAddendumDetails = CyberSource::V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum.new
    invoiceDetails.purchase_order_number = "LevelIII Auth Po"
    transactionAdviceAddendumDetails.data = "1Order#Of20Pens30Pencils4%notepads2books"
    invoiceDetails.transaction_advice_addendum = transactionAdviceAddendumDetails
    transactionAdviceAddendumDetails.data = "2Order#Of20Pens30Pencils4%notepads2books"
    invoiceDetails.transaction_advice_addendum = transactionAdviceAddendumDetails
    transactionAdviceAddendumDetails.data = "3Order#Of20Pens30Pencils4%notepads2books"
    invoiceDetails.transaction_advice_addendum = transactionAdviceAddendumDetails
    transactionAdviceAddendumDetails.data = "4Order#Of20Pens30Pencils4%notepads2books"
    invoiceDetails.transaction_advice_addendum = transactionAdviceAddendumDetails
    ...
    amountInformation.total_amount = "113.00"
    ...
    cardInformation.number = "378282246310005"
