...
class PartialAuthorization
  def main
    ...
    pointOfSaleInformationEMV = CyberSource::V2paymentsPointOfSaleInformationEmv.new
    pointOfSaleInformation.card_present = "true"
    pointOfSaleInformation.cat_level = 6
    pointOfSaleInformation.terminal_capability = 4
    pointOfSaleInformationEMV.fallback_condition = "swipped"
    pointOfSaleInformationEMV.fallback = "N"
    ...
    amountInformation.total_amount = "7012.00"
