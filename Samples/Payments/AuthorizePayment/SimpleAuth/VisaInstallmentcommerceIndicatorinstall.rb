...
public
class VisaInstallmentcommerceIndicatorinstall
  def main
    ...
    processingInformation.commerce_indicator = "moto"
    ...
    amountInformation.total_amount = "109.00"
  ...
  VisaInstallmentcommerceIndicatorinstall.new.main
end
