...
class Retail
  def main
    ...
    pointOfSaleInformation.entry_mode = "QRCode"
    ...
    processingInformation.payment_solution = "007"
    ...
    tokenizedCard = CyberSource::V2paymentsPaymentInformationTokenizedCard.new
    tokenizedCard.transaction_type = "1"
    tokenizedCard.requestor_id = "12345678901"
    paymentInformation.tokenized_card = tokenizedCard
